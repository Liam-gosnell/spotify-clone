    ...
    async jwt ({token, account, user}){
      ...
      if (account && user) {
          return {
            ...
            accessTokenExpires: account.expires_at * 1000, // handling in miliseconds hence * 1000
          };
      }

      // Retrun previous token if the access token has not expired yet
